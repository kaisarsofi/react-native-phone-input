...
| --- | --- | --- | --- |
| `defaultCountry` | `CountryCode` | device locale, else `'US'` | Initial country (uncontrolled). When omitted, detected from the device's locale region (e.g. a device set to `en-IN` starts on India) |
